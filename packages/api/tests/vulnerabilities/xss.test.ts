...
describe('XSS / Weak Crypto Vulnerabilities - CWE-79, CWE-327, CWE-338', () => {
  ...
  it('VULNERABLE: React catalog preserves reflected and stored XSS sinks (CWE-79)', () => {
    const productSource = fs.readFileSync('../web/src/products.tsx', 'utf8');
    const authSource = fs.readFileSync('../web/src/authPages.tsx', 'utf8');
    const accountSource = fs.readFileSync('../web/src/accountPages.tsx', 'utf8');
    const adminSource = fs.readFileSync('../web/src/adminPages.tsx', 'utf8');
